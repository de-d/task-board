...
import {FileItem, Comment, User} from "@/types/TaskDetail";
...
export default function TaskDetail({taskId, setOpenModal, modal}: TaskDetailProps) {
    ...
    const {mutateAsync: commentSubmit} = useMutation({
        mutationFn: ({ formData, taskId }: { formData: FormData; taskId: number }) => addComments({ formData, taskId }),
        onSuccess: () => {
            queryClient.invalidateQueries({queryKey:['taskDetail']});
            setFilesComments([]);
            setContent("");
    ...
    const [selectValue, setSelectValue] = useState(taskDetail?.stage.name);
    ...
    async function submitTaskFile() {
        ...
        try {
            ...
            if (filesZone1.length > 0) {
                ...
                uploadedFiles.data.forEach((file: { id: number }) => {
                    addFileTask({ taskId: taskDetail.id, fileId: file.id });
                });
            }
    ...
    async function createComment(event: React.FormEvent<HTMLFormElement>) {
        ...
        try {
            ...
            await commentSubmit({ formData, taskId: taskDetail.id });
                        ...
                        <div className={styles.left_panel}>
                            <div className={styles.content}>
                                <div className={styles.task_name}>
                                    ...
                                    <div>
                                        <svg className={styles.task_icon} width="32" height="32" viewBox="0 0 32 32"
                                ...
                                <div className={styles.previewContainer}>
                                    {taskDetail.files.length > 0 && taskDetail.files.map((file:FileItem) => (
                                        <div key={file.id} className={styles.previewItem}>
                                            <div className={styles.deletion}
                                                 onClick={() => deleteFileTask({taskId: taskDetail.id, fileId: file.id})}
                                            >
                                            ...
                                            {allowedExtensions.some((ext) => file.link.endsWith(ext)) ? (
                                                <div className={styles.previewImage}>
                                                    <Image
                                                        src={`https://trainee-academy.devds.ru/${file.link}`}
                                                        alt={`preview-${file.id}`}
                                                    />
                                                </div>
                                            ) : (
                                                <div className={classes.filesImage}>
                                                    <svg className={styles.task_icon} width="180"
                                                         height="75" viewBox="0 0 53 67" fill="none"
                                                         xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                            ...
                                            <div className={styles.ImageInfo}>
                                                <a href={`https://trainee-academy.devds.ru/${file.link}`}>
                                                    {file.original_name}
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <form onSubmit={createComment} className={styles.comments}>
                                    ...
                                    <button type="submit" className={styles.comments_button}>Отправить</button>
                                </form>

                                <div className={styles.comments_area}>
                                    {taskDetail.comments && taskDetail.comments.length > 0 && (
                                        taskDetail.comments.map((comments:Comment) => (
                                            <div key={comments.id} className={styles.comments_content}>
                                                    ...
                                                    <div className={styles.userinfo}>
                                                        {comments.user.avatar ? (
                                                            ...
                                                            <Image
                                                                ...
                                                                height={100}
                                                                className={styles.avatar}
                                                                src={'/img/task/default_user.png'}
                                                                alt='avatar'
                                                            />
                                                        )}
                                                        <div>
                                                            <div className={styles.username}>
                                                                <span>{comments.user.name} {comments.user.surname}</span>
                                                            </div>
                                                            ...
                                                            <>
                                                                ...
                                                                <svg onClick={() => {
                                                                    ...
                                                                    setEditingCommentId(comments.id)
                                                                     ...
                                                                     className={styles.task_icon} width="20" height="20"
                                                                ...
                                                                <svg className={styles.task_icon} width="20" height="20"
                                                                     viewBox="0 0 20 20" fill="none"
                                                                     xmlns="http://www.w3.org/2000/svg">
                                                                    <path
                                                                ...
                                                                <svg onClick={() => deleteComment(comments.id)}
                                                                     className={styles.task_icon} width="20" height="20"
                                                                     viewBox="0 0 20 20" fill="none"
                                                                     xmlns="http://www.w3.org/2000/svg">
                                                                    <path fillRule="evenodd" clipRule="evenodd"
                                                            ...
                                                            <div className={styles.editCross}>
                                                                <svg onClick={() => {
                                                                    ...
                                                                    setEditingCommentId(null)
                                                                     ...
                                                                     xmlns="http://www.w3.org/2000/svg">
                                                                    <path d="M18 6L6 18" stroke="#ABBED1"
                                                                          stroke-linecap="round" stroke-linejoin="round"/>
                                                                    <path d="M6 6L18 18" stroke="#ABBED1"
                                                                          stroke-linecap="round" stroke-linejoin="round"/>
                                                                </svg>
                                                            </div>
                                                        )}
                                                ...
                                                {openEditComment && editingCommentId === comments.id ?
                                                    (
                                                        <form onSubmit={(e) => updateComment(e, comments.id)}
                                                              className={styles.comments}>
                                                            <TextEditor content={comments.content} setContent={setContent}/>
                                                            <DropzoneButton files={editCommentFiles}
                                                                            setFiles={setEditCommentFiles}/>
                                                            <button type="submit"
                                                                    className={styles.comments_button}>Сохранить
                                                            </button>
                                                        </form>
                                                    )
                                                    : (
                                                ...
                                                <div className={styles.previewContainer}>
                                                    {comments.files.length > 0 && comments.files.map((file:FileItem) => (
                                                        <div key={file.id} className={styles.previewItem}>
                                                            <div className={styles.deletion}
                                                                 onClick={() => fileDelete({
                        ...
                        <div className={styles.right_panel}>
                            <div className={styles.right_panel__header}>
                                ...
                                <div>
                                    ...
                                    {(isAdmin) && (
                                        <svg onClick={() => handleDeleteClick(taskDetail.id)} className={styles.task_icon} width="32"
                            ...
                            <div className={styles.taskInfo}>
                                {taskDetail.priority?.id && (
                                    <div className={styles.taskInfo_priority}>
                                        <div className={styles.taskInfo_title}>
                                            Приоритет
                                        </div>
                                        <div className={styles.priority_body} style={{
                                            background: taskDetail.priority.id === 1
                                                ? '#FFF1F0'
                                                : taskDetail.priority.id === 2
                                                    ? '#FFF8EC'
                                                    : taskDetail.priority.id === 3
                                                    ? '#F1FBF8'
                                                        : '',
                                            color: taskDetail.priority.id === 1
                                                ? '#FF5A4F'
                                                : taskDetail.priority.id === 2
                                                    ? '#FFA826'
                                                    : taskDetail.priority.id === 3
                                            ...
                                            •{taskDetail.priority.name}
                                        </div>
                                    </div>
                                )}

                                {taskDetail.component?.name && (
                                    <div className={styles.taskInfo_stage}>
                                        <div className={styles.taskInfo_title}>
                                            Компонент
                                        </div>
                                        <div className={styles.stage_body} style={{ background: taskDetail.component.color }}>
                                            {taskDetail.component.name}
                                        </div>
                                    </div>
                                )}
                                ...
                                {taskDetail.task_type && (
                                    <div className={styles.taskInfo_type}>
                                        ...
                                        <div className={styles.type_body} style={{
                                            background: taskDetail.task_type.id === 1
                                                ? '#FFF1F0'
                                                : taskDetail.task_type.id === 2
                                                    ? '#EEF5FC'
                                                    : taskDetail.task_type.id === 3
                                                        ? '#F1FBF8'
                                                        : taskDetail.task_type.id === 4
                                                            ? '#FFF8EC'
                                                            : taskDetail.task_type.id === 5
                                                                ? '#F0EEFF'
                                                                : taskDetail.task_type.id === 6
                                                                    ? '#FFF1EC'
                                                                    : taskDetail.task_type.id === 7
                                                                        ? '#F4F6F8'
                                                                            : taskDetail.task_type.id === 8
                                                                                ? '#F4F6F8'
                                                                                : '',

                                            color: taskDetail.task_type.id === 1
                                                ? '#FF5A4F'
                                                : taskDetail.task_type.id === 2
                                                    ? '#3787EB'
                                                    : taskDetail.task_type.id === 3
                            ...
                            <div className={styles.estimation}>
                                ...
                                <div className={styles.estimation_time}>
                                    ...
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path className={styles.task_icon}
                            ...
                            <div className={styles.task_date}>
                                <div className={styles.task_date_info}>
                                    ...
                                    <div className={styles.task_date_begin_date}>
                                        ...
                                        <span>{format(new Date(taskDetail.created_at), 'dd.MM.yyyy')}</span>
                                    </div>
                                </div>
                                <div className={styles.task_date_info}>
                                    ...
                                    <div className={styles.task_date_begin_date}>
                                        ...
                                        <span>{format(new Date(taskDetail.updated_at), 'dd.MM.yyyy')}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className={styles.project_info}>
                                ...
                                <Link href='#'>{taskDetail.project.name}</Link>
                            </div>

                            {taskDetail.users && taskDetail.users.length > 0 && (
                            <div className={styles.executor}>
                                <span className={styles.executor_title}>Исполнитель</span>
                                {taskDetail.users.map((user:User, index:number)=> (
                            ...
                            <div className={styles.executor}>
                                <span className={styles.executor_title}>Постановщик</span>
                                    <div className={styles.executor_detail}>
                                        {taskDetail.created_by?.avatar?.link? (
                                            <Image
                                                width={100}
                                                height={100}
                                                className={styles.avatar}
                                                src={`https://trainee-academy.devds.ru/${taskDetail.created_by?.avatar?.link}`}
                                                alt='avatar'
                                            />
                                        ): (
                                            <Image
                                        ...
                                        <div >
                                            <span>{taskDetail.created_by?.name} {taskDetail.created_by?.surname}</span>
                                        </div>
                                    </div>
                            </div>
                            ...
                            <div className={styles.link}>
                                {taskDetail.layout_link && (
                                    <div className={styles.task_link}>
                                        ...
                                        <div className={styles.link_body}>
                                            <a href={taskDetail.layout_link}>
                                                {taskDetail.layout_link.length > 55
                                                    ? `${taskDetail.layout_link.substring(0, 55)}...`
                                                    : taskDetail.layout_link}
                                            </a>
                                            <svg className={styles.task_icon} width="20" height="20" viewBox="0 0 20 20"
                                ...
                                <div className={styles.task_link}>
                                    ...
                                    <div className={styles.link_body}>
                                        <a href={taskDetail.markup_link}>
                                            {taskDetail.markup_link.length > 55
                                                ? `${taskDetail.markup_link.substring(0, 55)}...`
                                                : taskDetail.markup_link}
                                        </a>
                                        <svg className={styles.task_icon} width="20" height="20" viewBox="0 0 20 20"
                                             fill="none" xmlns="http://www.w3.org/2000/svg">
